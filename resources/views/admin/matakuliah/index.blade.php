...
@section('title', 'Mata Kuliah | Dashboard')
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="">
                                            <a href="{{ route('matakuliah.show', Crypt::encrypt($prodi->id)) }} "
                                                class="btn btn-sm btn-warning"><i class="fa fa-plus">Matkul</a></i>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
